...
INSERT INTO AUTHOR (ID, VERSION, AUTHOR_NAME, NATIONALITY, BIO) VALUES (3, 0, 'Kurt Vonnegut', 'American', '');
INSERT INTO AUTHOR (ID, VERSION, AUTHOR_NAME, NATIONALITY, BIO) VALUES (4, 0, 'John Steinbeck', 'American', '');
INSERT INTO AUTHOR (ID, VERSION, AUTHOR_NAME, NATIONALITY, BIO) VALUES (5, 0, 'Henry Charles Bukowski', 'German-American', '');
INSERT INTO AUTHOR (ID, VERSION, AUTHOR_NAME, NATIONALITY, BIO) VALUES (6, 0, 'Neil Gaiman', 'British', '');
INSERT INTO AUTHOR (ID, VERSION, AUTHOR_NAME, NATIONALITY, BIO) VALUES (7, 0, 'Philip K. Dick', 'American', '');
