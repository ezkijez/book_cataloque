...
export class Book {
    ...
    public constructor(title:string,genre:string,pdate:Date,authors:Set<Author>,reviews:Set<Review>){
        this._title = title;
        this._genre = genre;
    ...
    public get authors():Set<Author>{
        ...
        this._authors.forEach(function(a){
            authors.add(a);
        });
        return authors;
    ...
    public get reviews():Set<Review>{
        let reviews = new Set<Review>();
        this._reviews.forEach(function(r){
            reviews.add(r);
        });
        return reviews;
